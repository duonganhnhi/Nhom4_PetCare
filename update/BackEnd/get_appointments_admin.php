...
$sql = "SELECT id, name, phone, date, time, pets, serviceName, servicePrice, weight, paymentMethod, payment_status, username FROM appointments order by date desc limit 5";
