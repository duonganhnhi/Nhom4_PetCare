...
// Câu truy vấn SELECT tổng hợp tổng số đơn đặt và tổng giá tiền theo từng dịch vụ và từng tháng
$sql = "SELECT 
            serviceName, 
            MONTH(date) AS month, 
            YEAR(date) AS year, 
        ...
        GROUP BY serviceName, YEAR(date), MONTH(date)
        ORDER BY year, month, serviceName ASC";
